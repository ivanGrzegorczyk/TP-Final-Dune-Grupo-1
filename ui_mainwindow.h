...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        view->setGeometry(QRect(0, 0, 782, 566));
        view->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
        verticalLayoutWidget = new QWidget(widget);
        verticalLayoutWidget->setObjectName(QString::fromUtf8("verticalLayoutWidget"));
        verticalLayoutWidget->setGeometry(QRect(580, 10, 160, 80));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QCoreApplication::translate("MainWindow", "Hi! This is a label", nullptr));
        edit_button->setText(QCoreApplication::translate("MainWindow", "PushButton", nullptr));
    } // retranslateUi
